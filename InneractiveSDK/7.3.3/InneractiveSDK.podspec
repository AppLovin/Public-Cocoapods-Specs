...
s.source = 
{ 
    :http => 'https://bintray.com/applovin/iOS-Adapter-SDKs/download_file?file_path=InneractiveSDK-7.3.3.zip',
  	:type => 'zip',
	:sha256 => '5e7c90c0f96a5d3cc91100c0c6148cfe62826c64f74db31d0bc92f99a7c0ebf0'
}
s.description = <<-DESC
...
s.vendored_frameworks = 'InneractiveSDK-7.3.3/IASDKCore/IASDKCore.framework', 'InneractiveSDK-7.3.3/IASDKMRAID/IASDKMRAID.framework', 'InneractiveSDK-7.3.3/IASDKVideo/IASDKVideo.framework', 'InneractiveSDK-7.3.3/IASDKNative/IASDKNative.framework'
s.resource = 'InneractiveSDK-7.3.3/IASDKCore/IASDKResources.bundle'
