...
s.source = 
{ 
  :http => 'https://bintray.com/applovin/iOS-Adapters/download_file?file_path=AppLovinMediationFyberAdapter-7.3.0.0.zip',
  :type => 'zip',
  :sha256 => '4e01be17627e67010e33711cfe96b586618cd1d21cfd4cfb64727617026d857c'
}

s.vendored_frameworks = 'AppLovinMediationFyberAdapter-7.3.0.0/AppLovinMediationFyberAdapter.framework'
