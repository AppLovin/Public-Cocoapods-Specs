...
s.source = 
{ 
  :http => 'https://bintray.com/applovin/iOS-Adapters/download_file?file_path=AppLovinMediationMintegralAdapter-4.9.4.0.zip',
  :type => 'zip',
  :sha256 => '0f16fb81646514c7e415b87798a95f8bcf6724a285ce4b74357a8fd3f6629e73'
}

s.vendored_frameworks = 'AppLovinMediationMintegralAdapter-4.9.4.0/AppLovinMediationMintegralAdapter.framework'

s.dependency 'MintegralSDK', '= 4.9.4.0'
