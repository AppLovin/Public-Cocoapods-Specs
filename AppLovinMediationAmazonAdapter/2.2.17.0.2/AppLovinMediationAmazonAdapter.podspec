...
s.source =
{
  	:http => 'https://bintray.com/applovin/iOS-Adapters/download_file?file_path=AppLovinMediationAmazonAdapter-2.2.17.0.2.zip',
  	:type => 'zip',
	:sha256 => '0212142d2a3810ea2dc464affc259e3a9f3440ad01f369db75b5fc1b5f6726a3'
}

s.vendored_frameworks = 'AppLovinMediationAmazonAdapter-2.2.17.0.2/AppLovinMediationAmazonAdapter.framework'
