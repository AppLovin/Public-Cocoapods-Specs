...
s.source =
{
  	:http => 'https://bintray.com/applovin/iOS-Adapters/download_file?file_path=AppLovinMediationAmazonAdapter-3.0.0.0.0.zip',
  	:type => 'zip'
}

s.vendored_frameworks = 'AppLovinMediationAmazonAdapter-3.0.0.0.0/AppLovinMediationAmazonAdapter.framework'
