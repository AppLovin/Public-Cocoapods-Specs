...
s.source =
{
  	:http => 'https://bintray.com/applovin/iOS-Adapters/download_file?file_path=AppLovinMediationAmazonAdapter-2.2.17.0.1.zip',
  	:type => 'zip',
	:sha256 => '2fe9b880d1f1ba27cd36f0b85b1ba3cf20ae35f84057f6e94c569a8895546d62'
}

s.vendored_frameworks = 'AppLovinMediationAmazonAdapter-2.2.17.0.1/AppLovinMediationAmazonAdapter.framework'
