...
s.license = { :type => 'MIT', :file => 'VoodooAds-3.1.5/LICENSE' }
s.source =
{
    :http => 'https://bintray.com/applovin/iOS-Adapter-SDKs/download_file?file_path=VoodooAds-3.1.5.zip',
  	:type => 'zip'
}
s.description = <<-DESC
...
s.vendored_frameworks = 'VoodooAds-3.1.5/VoodooAds.framework'
s.resources           = 'VoodooAds-3.1.5/VoodooAds.framework/*.bundle'
