...
{ 
  ...
  :tag => '6.0.2-snakebacon'
}
s.vendored_frameworks = 'AppLovinSDK/snakebacon/6.0.2/AppLovinSDK.framework'
s.module_map = 'AppLovinSDK/snakebacon/6.0.2/AppLovinSDK.framework/Modules/module.modulemap'
