...
s.source = 
{ 
  :http => 'https://bintray.com/applovin/iOS-Adapters/download_file?file_path=AppLovinMediationVungleAdapter-6.7.2.0.zip',
  :type => 'zip'
}

s.vendored_frameworks = 'AppLovinMediationVungleAdapter-6.7.2.0/AppLovinMediationVungleAdapter.framework'

s.dependency 'VungleSDK-iOS', '= 6.7.2'
