...
s.name = 'AmazonPrebidSDK'
s.version = '2.2.17.0'
s.platform = :ios
s.ios.deployment_target = '9.0'
s.summary = 'Amazon Bidding SDK'
s.homepage = 'https://developer.amazon.com/public/apis/earn/mobile-ads'
s.license = { :type => 'Custom', :file => 'AmazonPrebidSDK-2.2.17.0/LICENSE.txt' }
s.source = 
{ 
    :http => 'https://bintray.com/applovin/iOS-Adapter-SDKs/download_file?file_path=AmazonPrebidSDK-2.2.17.0.zip',
    :type => 'zip',
}
s.description = <<-DESC
...
s.vendored_frameworks = 'AmazonPrebidSDK-2.2.17.0/DTBiOSSDK.framework'
